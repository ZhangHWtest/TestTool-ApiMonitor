...
public class PostManResolver {
	...
	public static ArrayList<HttpRequest> readV1FromJsonText(String jsonText){
		...
		for(Object obj : requests){
			...
			httpRequest.setHttpMethod(HttpRequest.HttpMethod.valueOf(request.getString("method").toUpperCase()));
			//header
                ...
                while(jsonReader.hasNext()) {
                    ...
                    while(jsonReader.hasNext()) {
                    	...
                    	if(objKey.equals("id")){
                			...
                			httpRequest.setHttpMethod(HttpRequest.HttpMethod.valueOf(jsonReader.readString().toUpperCase()));
